"use strict";
cc._RF.push(module, '4f565FycQFGr6Li9YrLAlyE', 'game');
// scripts/game.js
...
cc.Class({
    ...
    //生成新子弹的函数
    shootNewBullet: function shootNewBullet(speedCoefficient, speedIntercept, T, w) {
        //子弹数组存储新子弹
    ...
    //返回子弹的初始速度与方向:
    //随机各向同性子弹
    bulletRandomIsotropyInitializer: function bulletRandomIsotropyInitializer(speedCoefficient, speedIntercept) {
        var speed = cc.random0To1() * speedCoefficient + speedIntercept;
        var theta = cc.random0To1() * 2 * Math.PI;
        return [speed, theta];
    },
    //螺旋子弹
    bulletSpiralInitializer: function bulletSpiralInitializer(speedIntercept, T, w) {
