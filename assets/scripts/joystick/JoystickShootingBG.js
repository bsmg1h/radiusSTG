var Common = require('JoystickShootingCommon');
...
cc.Class({
    ...
    {
        // joy下的Game组件
        this._joyCom = this.node.parent.getComponent('JoystickShooting');
        // game组件下的player节点
    ...
    update: function(dt)
    {
     ...
     //全方向移动
    _allDirectionsShoot: function(dt)
    {
        if (this._speed != 0){
            this._playerNode.getComponent("player").playerShoot(dt,this._angle * (Math.PI/180));
        }
    },
